...
function scene:create(event)
    ...
    local page_image = display.newImage(sceneGroup, 'views/page08/page.png')
    ...
    local btn_reset = ButtonResetApp.create({ scene_group = sceneGroup, path_next_page = 'views.page01.index'})
